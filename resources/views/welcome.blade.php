...
<html lang="{{ config('app.locale') }}">
    <head>
        ...
        <!-- Fonts -->
        <link rel="stylesheet" href="/public/adminlte/css/style.css" type="text/css" media="screen, projection" />
        <link href="https://fonts.googleapis.com/css?family=Raleway:100,600" rel="stylesheet" type="text/css">
        <script type="text/javascript" src="/adminlte/js/verlet-1.0.0.js"></script>
    ...
    <body>
    <script type="text/javascript" src="/adminlte/js/common.js"></script>
    ...
    <div class="flex-center position-ref full-height">
            ...
            @endif
                <div id="app"></div>
            <div class="content">
                <canvas id="scratch" style="width: 1120px; height: 700px;"></canvas>
